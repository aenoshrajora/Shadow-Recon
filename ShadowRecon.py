...
# Shadow Recon: Silently carving through the web—one target at a time.
# Author: Aeenosh Rajora
# Github: https://github.com/aenoshrajora/Shadow-Recon
# Website: https://aenoshrajora.netlify.app/
...
# Banner Function
def banner():
    print(c.YELLOW + r"  _________.__                 .___                   __________   ")
    print(r" /   _____/|  |__  _____     __| _/ ____ __  _  __    \______   \  ____   ____   ____    ____   ")
    print(r" \_____  \ |  |  \ \__  \   / __ | /  _ \\ \/ \/ /     |       _/_/ __ \_/ ___\ /  _ \  /    \  ")
    print(r" /        \|   Y  \ / __ \_/ /_/ |(  <_> )\     /      |    |   \\  ___/\  \___(  <_> )|   |  \          - By Shadow Exploit")
    print(r"/_______  /|___|  /(____  /\____ | \____/  \/\_/       |____|_  / \___  >\___  >\____/ |___|  / ")
    print(r"       \/      \/      \/      \/                            \/      \/     \/             \/  " + c.END)
    ...
    try:
        ...
        print(c.BLUE + "Internet connection: " + c.RED + "✕ (error)" + c.END)
